...
const Home = () => {
	...
	const homeInfoTopDistance = adjustHomeInfo();

	return (
		<section className="w-full h-screen relative">
			{/* home info */}
			<div
				className={`absolute ${homeInfoTopDistance} left-0 right-0 z-10 flex items-center justify-center`}
			>
				{currentStage && <HomeInfo currentStage={currentStage} />}
			</div>

			<Canvas
				className={`w-full md:h-[100vh] h-[calc(100vh - 64px)] bg-transparent ${
